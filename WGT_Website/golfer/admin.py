...
class GolferRoundScoresAdmin (admin.ModelAdmin):
    ...
    # This method returns the tournament name from the TournGolfer class object, using the Foreign Key link
    ...
    # This method returns the golfer name from the TournGolfer class object, using the ForeignKey link
